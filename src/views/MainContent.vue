...
export default {
  ...
  methods: {
    ...
    removeTabHandle (tabName) {
      ...
      this.mainTabsList=this.mainTabs;
      if (this.$refs.routerView.$vnode)
      {
        if (this.$refs.routerView.$vnode.componentOptions)
        {
          var key = this.$refs.routerView.$vnode.key == null? this.$refs.routerView.$vnode.componentOptions.Ctor.cid + (this.$refs.routerView.$vnode.componentOptions.tag ? `::${this.$refs.routerView.$vnode.componentOptions.tag}` : ''): this.$refs.routerView.$vnode.key;
          var cache = this.$refs.routerView.$vnode.parent.componentInstance.cache;
          var keys  = this.$refs.routerView.$vnode.parent.componentInstance.keys;
          if (cache[key])
          {
            if (keys.length)
            {
