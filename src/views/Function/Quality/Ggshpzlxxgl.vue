...
<div>
  ...
  <e-dialogs :dialogTitle="GgshpzlxxglDialog" :status="GgshpzlxxglStatus" :dialog-width="800" :dialog-height="600" @dialogClose="dialogClose">
    <el-form-row ref-name="dtlForm" :model="GgshpzlxxglDtlForm" label-width="110px" style="margin-top:10px;">
      ...
      <el-form-col-item-input :span="12" label="生产批文效期" prop="approvePeriod" v-model="GgshpzlxxglDtlForm.approvePeriod" ></el-form-col-item-input>
      ...
      <el-form-col-item-input :span="12" label="质量标准效期" prop="qualitystandardperiod" v-model="GgshpzlxxglDtlForm.qualitystandardperiod"></el-form-col-item-input>
      ...
      <el-form-col-item-input :span="12" label="检验报告单效期" prop="inspectionperiod" v-model="GgshpzlxxglDtlForm.inspectionperiod"></el-form-col-item-input>
      ...
      <el-form-col-item-input :span="12" label="药品委托生产批件效期" prop="commissproduceperiod" v-model="GgshpzlxxglDtlForm.commissproduceperiod"></el-form-col-item-input>
