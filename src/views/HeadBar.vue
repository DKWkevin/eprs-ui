  ...
  <div class="headbar" :style="{'background':themeColor}"  
    ...
    <span class="toolbar">
      <el-menu class="el-menu-demo" :background-color="themeColor" text-color="#14889A" 
        ...
        <el-menu-item index="4" v-popover:popover-notice  @click="messageOpen">
          <!-- 系统通知 -->
          <el-badge :value="unreadNum" :max="99" class="badge">
           <li style="color:#fff;font-size:20px;" class="fa fa-commenting-o" ></li>
            <!-- <li style="color:#fff;" class="fa fa-bell-o fa-lg" @click="messageOpen"></li>-->
          </el-badge>
...
import {openStocket,socketClose,socketOpen} from '@/utils/socket'
...
export default {
  ...
  methods: {
    ...
    messageOpen () {
      this.$refs.messageChat.diaglogStatus = true;
      socketOpen();
    }
  },
  mounted() {
    ...
    if (username) {
      ...
      this.user.avatar = require("@/assets/logomini.png")
    }
  },
  computed:{
    ...mapState({
      ...
      unreadNum:state=>state.socket.unreadNum
    })
  }
}
</script>
